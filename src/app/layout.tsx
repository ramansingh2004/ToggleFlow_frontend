...
export const metadata: Metadata = {
  ...
  title: {
    default:
      'ToggleFlow — Feature Release Control',
  ...
  twitter: {
    ...
    title:
      'ToggleFlow — Feature Release Control',
    description:
      'Developer-first feature flags and release infrastructure.',
  },
...
export default function RootLayout({
  ...
  return (
    ...
    >
      <body className="min-h-screen bg-[#07090f] font-sans text-zinc-100 antialiased">
